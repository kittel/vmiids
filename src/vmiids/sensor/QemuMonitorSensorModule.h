...
public:
	 ...
	 * commit device|all 				-- commit changes to the disk images (if -snapshot is used) or backing files
	 */
	void cmdCommit(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * info [subcommand] 				-- show various information about the system state
	 */
	void cmdInfo(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * q|quit  					-- quit the emulator
	 */
	void cmdQuit(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * eject [-f] device 				-- eject a removable medium (use -f to force it)
	 */
	void cmdEject(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * change device filename [format]		 	-- change a removable medium, optional format
	 */
	void cmdChange(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * screendump filename 				-- save screen into PPM image 'filename'
	 */
	void cmdScreendump(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * logfile filename 				-- output logs to 'filename'
	 */
	void cmdLogfile(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * log item1[,...] 				-- activate logging of the specified items to '/tmp/qemu.log'
	 */
	void cmdLog(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * savevm [tag|id] 				-- save a VM snapshot. If no tag or id are provided, a new snapshot is created
	 */
	void cmdSavevm(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * loadvm tag|id 					-- restore a VM snapshot from its tag or id
	 */
	void cmdLoadvm(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * delvm tag|id 					-- delete a VM snapshot from its tag or id
	 */
	void cmdDelvm(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * singlestep [on|off] 				-- run emulation in singlestep mode or switch to normal mode
	 */
	void cmdSinglestep(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * stop  						-- stop emulation
	 */
	void cmdStop(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * c|cont  					-- resume emulation
	 */
	void cmdCont(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * gdbserver [device] 				-- start gdbserver on given device (default 'tcp::1234'), stop with 'none'
	 */
	void cmdGdbserver(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * x /fmt addr 					-- virtual memory dump starting at 'addr'
	 */
	void cmdX(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * xp /fmt addr 					-- physical memory dump starting at 'addr'
	 */
	void cmdXp(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * p|print /fmt expr 				-- print expression value (use $reg for CPU register access)
	 */
	void cmdPrint(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * i /fmt addr 					-- I/O port read
	 */
	void cmdI(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * o /fmt addr value 				-- I/O port write
	 */
	void cmdO(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * sendkey keys [hold_ms] 				-- send keys to the VM (e.g. 'sendkey ctrl-alt-f1', default hold time=100 ms)
	 */
	void cmdSendkey(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * system_reset  					-- reset the system
	 */
	void cmdSystem_reset(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * system_powerdown  				-- send system power down event
	 */
	void cmdSystem_powerdown(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * sum addr size 					-- compute the checksum of a memory region
	 */
	void cmdSum(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * usb_add device 					-- add USB device (e.g. 'host:bus.addr' or 'host:vendor_id:product_id')
	 */
	void cmdUsb_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * usb_del device 					-- remove USB device 'bus.addr'
	 */
	void cmdUsb_del(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * device_add device 				-- add device, like -device on the command line
	 */
	void cmdDevice_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * device_del device 				-- remove device
	 */
	void cmdDevice_del(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * cpu index 					-- set the default CPU
	 */
	void cmdCpu(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * mouse_move dx dy [dz] 				-- send mouse move events
	 */
	void cmdMouse_move(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * mouse_button state 				-- change mouse button state (1=L, 2=M, 4=R)
	 */
	void cmdMouse_button(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * mouse_set index 				-- set which mouse device receives events
	 */
	void cmdMouse_set(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * wavcapture path [frequency [bits [channels]]] 	-- capture audio to a wave file (default frequency=44100 bits=16 channels=2)
	 */
	void cmdWavecapture(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * stopcapture capture index 			-- stop capture
	 */
	void cmdStopcapture(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * memsave addr size file 				-- save to disk virtual memory dump starting at 'addr' of size 'size'
	 */
	void cmdMemsave(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * pmemsave addr size file 			-- save to disk physical memory dump starting at 'addr' of size 'size'
	 */
	void cmdPmemsave(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * boot_set bootdevice 				-- define new values for the boot device list
	 */
	void cmdBoot_set(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * nmi cpu 					-- inject an NMI on the given CPU
	 */
	void cmdNmi(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * 			 -i for migration without shared storage with incremental copy of disk (base image shared between src and destination)
	 */
	void cmdMigrate(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * migrate_cancel  				-- cancel the current VM migration
	 */
	void cmdMigrate_cancel(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * migrate_set_speed value 			-- set maximum speed (in bytes) for migrations
	 */
	void cmdMigrate_set_speed(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * migrate_set_downtime value 			-- set maximum tolerated downtime (in seconds) for migrations
	 */
	void cmdMigrate_set_downtime(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * 	[snapshot=on|off][,cache=on|off] 	-- add drive to PCI storage controller
	 */
	void cmdDrive_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * 	[host=02:00.0[,name=string][,dma=none] 	-- hot-add PCI device
	 */
	void cmdPci_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * host_net_add tap|user|socket|vde|dump [options] -- add host VLAN client
	 */
	void cmdHost_net_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * host_net_remove vlan_id name 			-- remove host VLAN client
	 */
	void cmdHost_net_remove(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * 	[guestaddr]:guestport 			-- redirect TCP or UDP connections from host to guest (requires -net user)
	 */
	void cmdHostfwd_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * 	[tcp|udp]:[hostaddr]:hostport 		-- remove host-to-guest TCP or UDP redirection
	 */
	void cmdHostfwd_remove(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * balloon target 					-- request VM to change it's memory allocation (in MB)
	 */
	void cmdBalloon(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * set_link name up|down 				-- change the link status of a network adapter
	 */
	void cmdSet_link(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * [reset|shutdown|poweroff|pause|debug|none] 	-- change watchdog action
	 */
	void cmdWatchdog_action(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * acl_show aclname 				-- list rules in the access control list
	 */
	void cmdAcl_show(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * acl_policy aclname allow|deny 			-- set default access control list policy
	 */
	void cmdAcl_policy(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * acl_add aclname match allow|deny [index] 	-- add a match rule to the access control list
	 */
	void cmdAcl_add(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * acl_remove aclname match 			-- remove a match rule from the access control list
	 */
	void cmdAcl_remove(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * acl_reset aclname 				-- reset the access control list
	 */
	void cmdAcl_reset(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * mce cpu bank status mcgstatus addr misc 	-- inject a MCE on the given CPU
	 */
	void cmdMce(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * getfd getfd name 				-- receive a file descriptor via SCM rights and assign it a name
	 */
	void cmdGetfd(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * closefd closefd name 				-- close a file descriptor previously passed via SCM rights
	 */
	void cmdClosefd(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * block_passwd block_passwd device password 	-- set the password of encrypted block devices
	 */
	void cmdBlock_passwd(std::string &helptext) throw(vmi::ModuleException);
	 ...
	 * cpu_set cpu [online|offline] 			-- change cpu state
	 */
	void cmdCpu_set(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the help of the info command.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoHelp(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the version of QEMU.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoVersion(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief list QMP available commands.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoCommands(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the network state.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoNetwork(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the character devices.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoChardev(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the block devices.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoBlock(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show block device statistics.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoBlockstats(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the cpu registers.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoRegisters(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show infos for each CPU.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoCpus(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the command line history.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoHistory(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the interrupts statistics (if available).
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoIrq(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show i8259 (PIC) state.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoPic(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show PCI info.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoPci(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show virtual to physical memory mappings.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoTlb(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the active virtual memory mappings.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoMem(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show state of HPET.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoHpet(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show dynamic compiler info.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoJit(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show KVM information.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoKvm(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show NUMA information.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoNuma(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show guest USB devices.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoUsb(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show host USB devices.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoUsbhost(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show profiling information.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoProfile(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show capture information.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoCapture(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the currently saved VM snapshots.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoSnapshots(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the current VM status (running|paused).
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoStatus(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show guest PCMCIA status.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoPcmcia(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show which guest mouse is receiving events.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoMice(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the vnc server status.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoVnc(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the current VM name.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoName(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show the current VM UUID.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoUuid(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show user network stack connection states.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoUsernet(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show migration status.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoMigrate(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show balloon information.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoBallon(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show device tree.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoQtree(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show qdev device model list.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoQdm(std::string &helptext) throw(vmi::ModuleException);

	/**
	 * \brief show roms.
	 * @param helptext String Buffer in which the result will be returned in.
	 */
	void infoRoms(std::string &helptext) throw(vmi::ModuleException);
